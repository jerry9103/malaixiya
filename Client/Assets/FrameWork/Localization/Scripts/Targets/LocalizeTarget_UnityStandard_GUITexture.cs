...
namespace GameGoing.SDK
{
    ...
    #endif
    public class LocalizeTarget_UnityStandard_GUITexture : LocalizeTarget<Texture>
    {
        static LocalizeTarget_UnityStandard_GUITexture() { AutoRegister(); }
        [RuntimeInitializeOnLoadMethod] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<Texture, LocalizeTarget_UnityStandard_GUITexture>() { Name = "GUITexture", Priority = 100 }); }
        ...
        {
            primaryTerm = mTarget ? mTarget.name : string.Empty;
            secondaryTerm = null;
        }
        ...
        public override void DoLocalize(Localize cmp, string mainTranslation, string secondaryTranslation)
        {
            ...
            if (Old == null || Old.name != mainTranslation)
                mTarget = cmp.FindTranslatedObject<Texture>(mainTranslation);

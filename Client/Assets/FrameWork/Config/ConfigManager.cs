...
{
    private readonly Dictionary<string, List<ConfigDada>> AllConfig = new Dictionary<string, List<ConfigDada>>();
    private readonly Dictionary<string, Object> mConfigCach = new Dictionary<string, Object>();//还未解析的配置表，需要用到的时候才解析，以免托管堆内存占用过大

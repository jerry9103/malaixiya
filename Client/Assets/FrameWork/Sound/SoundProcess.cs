...
public class SoundProcess : MonoBehaviour
{
    ...
    public static bool m_IsIgnorSound = false;
    ...
    public static bool IgnorVoice { get { return m_IsIgnorSound; } }
    ...
    public static void LoadConfig()
    {
        ...
        m_IsShake = PlayerPrefs.GetInt("ShakeModel", m_IsShake ? 1 : 0) == 1 ? true : false;         //0关   1开
        m_IsDialect = PlayerPrefs.GetInt("DialectModel", m_IsDialect ? 1 : 0) == 1 ? true : false;

        m_IsIgnorSound = PlayerPrefs.GetInt("IgnorSound", 0) == 1;    // 1开 0 关
    ...
    public static void SetIgnorSound(bool ignor)
    {
        m_IsIgnorSound = ignor;
        PlayerPrefs.SetInt("IgnorSound", ignor ? 1 : 0);
    }
